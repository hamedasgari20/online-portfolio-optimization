...
def nsga2(s, w, r, i,  population, max_gen):
    ...
    while (gen_no < max_gen):
        # print(solution)
        objective1_values_un_normal = [objective1(solution.loc[j, :], r) for j in range(0, population)]
        objective2_values_un_normal = [objective2(w, solution.loc[k, :]) for k in range(0, population)]
